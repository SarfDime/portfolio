...
export default function Hero() {
    ...
    return (
        <>
            <main className="mainComponent introMain intro">
            ...
            <main className="mainComponent aboutMain about">
                <AboutInfo></AboutInfo>
                <Skills></Skills>
            </main>
        </>
